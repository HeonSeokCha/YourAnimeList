...
interface SearchRepository {
    ...
    suspend fun searchAnime(page: Input<Int>, search: Input<String>): Response<SearchAnimeQuery.Data>

    suspend fun searchManga(page: Input<Int>, search: Input<String>): Response<SearchMangaQuery.Data>
