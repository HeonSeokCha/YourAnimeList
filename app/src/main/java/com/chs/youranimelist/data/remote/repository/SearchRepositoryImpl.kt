...
class SearchRepositoryImpl @Inject constructor(
    ...
    override suspend fun searchAnime(page: Input<Int>, search: Input<String>) =
        apolloClient.query(
            SearchAnimeQuery(page, search)
        ).await()

    override suspend fun searchManga(page: Input<Int>, search: Input<String>) =
        apolloClient.query(
            SearchMangaQuery(page, search)
        ).await()

    override suspend fun searchCharacter(page: Input<Int>, search: Input<String>) =
        apolloClient.query(
