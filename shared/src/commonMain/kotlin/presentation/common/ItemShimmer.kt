...
object PlaceholderDefaults {
    /**
     * The default [androidx.compose.animation.core.InfiniteRepeatableSpec] to use for [fade].
     */
    ...
    /**
     * The default [androidx.compose.animation.core.InfiniteRepeatableSpec] to use for [shimmer].
     */
